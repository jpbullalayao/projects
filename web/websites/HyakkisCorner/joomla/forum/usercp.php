...
if($mybb->input['action'] == "do_profile" && $mybb->request_method == "post")
{
	...
	$user = array(
		...
		/* ADDED FOR GAMING PROFILES */
		"twitch" => $mybb->input['twitch'],
		"xone_gamertag" => $mybb->input['xone_gamertag'],
		"x360_gamertag" => $mybb->input['x360_gamertag'],
		"ps4_psn" => $mybb->input['ps4_psn'],
		"ps3_psn" => $mybb->input['ps3_psn'],
		"steam_user" => $mybb->input['steam_user'],
		"_3ds" => $mybb->input['_3ds'],
		"wiiu_user" => $mybb->input['wiiu_user'],
		"wii_num" => $mybb->input['wii_num'],
		
        /* ADDED FOR SOCIAL MEDIA */
        "facebook" => $mybb->input['facebook'],
        "youtube" => $mybb->input['youtube'],
        "twitter" => $mybb->input['twitter'],
        "instagram" => $mybb->input['instagram'],
        "vine" => $mybb->input['vine']
	);
...
if($mybb->input['action'] == "profile")
{
	...
	if($user['twitch'] == "" || $user['twitch'] == "http://twitch.tv/")
	{
		$user['twitch'] = "http://twitch.tv/";
	}
	else
	{
		$user['twitch'] = htmlspecialchars_uni($user['twitch']);
	}
	
    /* ADDED FOR SOCIAL MEDIA SECTION */
    if($user['facebook'] == "" || $user['facebook'] == "http://facebook.com/")
    {
        $user['facebook'] = "http://facebook.com/";   
    }
    else 
    {
        $user['facebook'] = htmlspecialchars_uni($user['facebook']);
    }
    if($user['youtube'] == "" || $user['youtube'] == "http://youtube.com/user/") 
    {
        $user['youtube'] = "http://youtube.com/user/";
    }
    else 
    {
        $user['youtube'] = htmlspecialchars_uni($user['youtube']);
    }
    /*if($user['facebook'] == "" || $user['facebook'] == "http://www.facebook.com/")
    {
        $user['facebook'] = "http://www.facebook.com/";   
    }
    else 
    {
        $user['facebook'] = htmlspecialchars_uni($user['facebook']);
    }
    if($user['youtube'] == "" || $user['youtube'] == "http://www.youtube.com/user/") 
    {
        $user['youtube'] = "http://www.youtube.com/user/";
    }
    else 
    {
        $user['youtube'] = htmlspecialchars_uni($user['youtube']);
    ...
    {
        $user['twitter'] = htmlspecialchars_uni($user['twitter']);    
    }
    ...
    {
        $user['instagram'] = htmlspecialchars_uni($user['instagram']);    
    }

...
class CjLibModelQueue extends JModelList {
	...
	protected function _buildQuery(){
		...
		$query->select('q.id, q.to_addr, q.status, q.html, q.processed');
		$query->from('#__corejoomla_messagequeue as q');
			
		$query->select('m.id as message_id, m.asset_id, m.asset_name, m.subject, m.created');
	...
	protected function getListQuery() {
		...
		$orderCol	= $this->state->get('list.ordering', 'm.created');

...
$config['database']['database'] = 'HyakkisForum';
$config['database']['table_prefix'] = 'mybb_';

$config['database']['hostname'] = 'HyakkisForum.db.10386188.hostedresource.com';
$config['database']['username'] = 'HyakkisForum';
$config['database']['password'] = 'Stevenyang@26';
